...
# Sub_metering 1:3 from characters to numbers
...
# the same bespoke x axis is used for all 4 plots
# define a 'list' of attributes to pass to `axis()` just once and reuse using `do.call()`.
x_axis_args <- list(1, at = c( 1, grep("2007-02-02", d$Date)[1], length(d$Date)), labels = c("Thurs", "Fri", "Sat"))
